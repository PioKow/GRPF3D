...
xe =  350;  % real part range end
yb = 25;  % imag part range begin
ye = 300;  % imag part range end 
tb = 1*1e12;  % addational paramter range begin
te = 7*1e12;  % addational paramter range end  
...
Scale = []; 
%Scale = [1,1,(1/50)*1e12];  
% 1/50 corresponds to the current proportion of the domain
